...
data.stb <-
  read_excel("/Users/Lakshay/Desktop/Honours/R data/14 dpf naglu/Statistics 20s time bin 14dpf naglu.xlsx")
data.stb <-
...
lets get some fat graphs on the roll - gonna try making a nice lil function first like karissa showed me for genotypes:  
...
IT WORKED, I am an actual fucking god. Connected time points of 2 mins to a range of 6. now I can join the fulldata to it by Bin and sneak in the range that way. This will hopefully allow me to average my velocities by trial, position and range number????????????????????????????????????????
...
MAKING IT INTO A GG ARRANGE THINGY.
